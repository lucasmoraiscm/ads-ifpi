...
import { Conta2, Cliente2, Banco2 } from "./banco";
...
do {
    ...
    console.log('11 - Total aplicado por clientes');
    console.log("0 - Sair\n")
    opcao = input("Opção: ");
...
function inserirConta(): void {
    ...
    let conta: Conta2 = new Conta2(numero, saldo);
...
function inserirCliente(): void {
    ...
    let cliente: Cliente2 = new Cliente2(nome, cpf, dataNascimento);
